...
def get_robots():
    '''
    get all available robots that
    Input: None
    Ouput: all robots and its corresponding IP address (dict)
    '''
...
def get_missions():
    '''
    Pulling mission templates
    Input: None
    Ouput: all mission templates (df)
    '''
...
def get_mission_queue_id(robot_name):
    '''
    Pulling mission queue log id from one robot
...
def get_robots_mission_log():
    '''
    Pulling mission log from ALL robots
    Input: None
    Ouput: robots' mission log (df)
    '''
    robot_dict = get_robots()
    df_all = pd.DataFrame()
...
def get_robots_error_log():
    '''
    Pulling error log from ALL robots
    Input: None
    Ouput: robots' error log (df)
    '''
    robot_dict = get_robots()
    df_all = pd.DataFrame()
    for robot_name in robot_dict.keys():
...
################################## EXAMPLES ##################################
df1 = get_robots_error_log()
df2 = get_robots_mission_log()